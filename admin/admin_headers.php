    ...
    <nav style="background-color: #333333">
        ...
        <div class="navigation">
            ...
            <ul class="menu">
                ...
                </li> <a href="admin_profile.php" class="delete-btn" style="margin-left: 50px; margin-bottom: 20px; margin-top: 15px; color: white; background-color: #8C3345">Update Profile</a></li>
